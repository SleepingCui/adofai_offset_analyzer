const I18N_STRINGS = {
    zh: {
        ...
        acfTitle: '自相关图', acfX: 'lag（间隔键数）',
        acfLag1: 'lag 1 相关系数', acfPairs: '有效配对',
        acfStrongest: '最强 lag (≥2)', acfBand: '95% 置信带',
        acfMultiTest: '50 个 lag 中约 2~3 个会仅因偶然超出置信带，单个尖峰不足以定性',
        deltaTitle: '相邻偏移量差值分布', deltaX: '相邻偏移量差值',
        deltaPairs: '有效对数', deltaMeanAbs: '平均 |Δ|', deltaMedianAbs: '中位数 |Δ|',
        deltaMean: '平均 Δ', deltaStdDev: '标准差 Δ',
    ...
    en: {
        ...
        acfTitle: 'Autocorrelation', acfX: 'Lag (hits)',
        acfLag1: 'Lag 1 correlation', acfPairs: 'Pairs',
        acfStrongest: 'Strongest lag (≥2)', acfBand: '95% confidence band',
        acfMultiTest: 'About 2-3 of 50 lags cross the band by chance alone, so a single spike proves nothing',
        deltaTitle: 'Offset Difference (Δ)', deltaX: 'Offset difference',
        deltaPairs: 'Pairs', deltaMeanAbs: 'Mean |Δ|', deltaMedianAbs: 'Median |Δ|',
        deltaMean: 'Mean Δ', deltaStdDev: 'Std Dev Δ',
    ...
    kr: {
        ...
        acfTitle: '자기상관', acfX: 'lag(타건 간격)',
        acfLag1: 'lag 1 상관계수', acfPairs: '유효 쌍',
        acfStrongest: '최강 lag (≥2)', acfBand: '95% 신뢰 구간',
        acfMultiTest: '50개 lag 중 2~3개는 우연히 신뢰 구간을 벗어나므로 단일 피크만으로는 판단할 수 없습니다',
        deltaTitle: '인접 오프셋 차이 분포', deltaX: '인접 오프셋 차이',
        deltaPairs: '유효 쌍', deltaMeanAbs: '평균 |Δ|', deltaMedianAbs: '중앙값 |Δ|',
        deltaMean: '평균 Δ', deltaStdDev: '표준편차 Δ',
